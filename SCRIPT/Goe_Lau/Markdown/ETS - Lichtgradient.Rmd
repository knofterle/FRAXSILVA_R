...
plot.all3(tree_data = tree_lau, plot_data = nv_plots, flaeche = "lau", 
					plotcolor = "ets_2022_ratio", plotcoloradapt = 1, plotsize = "n_trees_2022", 
					plotsizeadapt = 1, plotsizetotree = 0.2, treecolor = NA)
plot.all3(tree_data = tree_data_ansitz, plot_data = nv_plots, flaeche = "goe_ans", 
					plotcolor = "ets_2022_ratio", plotcoloradapt = 1, plotsize = "n_trees_2022", 
					plotsizeadapt = 1, plotsizetotree = 0.2, treecolor = NA)
plot.all3(tree_data = tree_data_polter, plot_data = nv_plots, flaeche = "goe_pol", 
					plotcolor = "ets_2022_ratio", plotcoloradapt = 1, plotsize = "n_trees_2022", 
					plotsizeadapt = 1, plotsizetotree = 0.2, treecolor = NA)
...
ggplot(data = tmp) +
	geom_point(aes(x = TSF, y = ETS_gewichtet), size = 3, alpha = 0.2) +
	geom_smooth(aes(x = TSF, y = ETS_gewichtet))
